#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 9 IE1.5 unweighted mean country ASR.pdf
#
# Manuscript figure: Supplementary Figure 9
# Valuation scenario: IE = 1.5
# Plotting code    : scripts/run_LMIC_Pancreatic_VLW_v2.R lines 790-807
# Shared preamble  : _common.R (= canonical script lines 1-348)
# Output           : fig/Supplementary Figure 9 IE1.5 unweighted mean country ASR.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 9 IE1.5 unweighted mean country ASR.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 9 IE1.5 unweighted mean country ASR.pdf")

# ---- Plot (canonical script lines 790-807) ----
