#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 4 IE0.5 maps.pdf
#
# Manuscript figure: Supplementary Figure 4
...
# Output           : fig/Supplementary Figure 4 IE0.5 maps.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 4 IE0.5 maps.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 4 IE0.5 maps.pdf")
