#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 3 IE0.5 unweighted mean country ASR.pdf
#
# Manuscript figure: Supplementary Figure 3
...
# Output           : fig/Supplementary Figure 3 IE0.5 unweighted mean country ASR.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 3 IE0.5 unweighted mean country ASR.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 3 IE0.5 unweighted mean country ASR.pdf")
