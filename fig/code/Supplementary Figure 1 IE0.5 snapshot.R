#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 1 IE0.5 snapshot.pdf
#
# Manuscript figure: Supplementary Figure 1
...
# Output           : fig/Supplementary Figure 1 IE0.5 snapshot.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 1 IE0.5 snapshot.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 1 IE0.5 snapshot.pdf")
