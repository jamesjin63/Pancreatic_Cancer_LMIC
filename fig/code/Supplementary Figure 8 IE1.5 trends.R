#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 8 IE1.5 trends.pdf
#
# Manuscript figure: Supplementary Figure 8
# Valuation scenario: IE = 1.5
# Plotting code    : scripts/run_LMIC_Pancreatic_VLW_v2.R lines 545-568
# Shared preamble  : _common.R (= canonical script lines 1-348)
# Output           : fig/Supplementary Figure 8 IE1.5 trends.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 8 IE1.5 trends.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 8 IE1.5 trends.pdf")

# ---- Plot (canonical script lines 545-568) ----
# Figure 2 — temporal
