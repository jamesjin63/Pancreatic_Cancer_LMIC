#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 10 IE1.5 maps.pdf
#
# Manuscript figure: Supplementary Figure 10
...
# Output           : fig/Supplementary Figure 10 IE1.5 maps.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 10 IE1.5 maps.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 10 IE1.5 maps.pdf")
