...
#
# Manuscript figure: Supplementary Figure 12
...
# Output           : fig/Supplementary Figure 12 IE1.5 forecast.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 12 IE1.5 forecast.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 12 IE1.5 forecast.pdf")
