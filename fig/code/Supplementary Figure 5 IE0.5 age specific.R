#!/usr/bin/env Rscript
# ==============================================================================
# Supplementary Figure 5 IE0.5 age specific.pdf
#
# Manuscript figure: Supplementary Figure 5
...
# Output           : fig/Supplementary Figure 5 IE0.5 age specific.pdf
#
...
#
# Run on its own:  Rscript "fig/code/Supplementary Figure 5 IE0.5 age specific.R"
# ==============================================================================
...
OUT <- file.path(FIG_DIR, "Supplementary Figure 5 IE0.5 age specific.pdf")
